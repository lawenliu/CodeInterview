...
* by as many numerical digits as possible, and interprets them as numerical
* value.
* The string can contain additional characters after thoes that form the integral
* number, which are ignored and have no effect on the behavior or this function.
